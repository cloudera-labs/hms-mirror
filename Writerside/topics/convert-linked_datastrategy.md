...
If you migrated schemas with the [Linked](linked_datastrategy.md) strategy and don't want to drop the database and run SCHEMA_ONLY to adjust the locations from the LEFT to the RIGHT cluster, use this strategy to make the adjustment.
