...
@Slf4j
public class decrypt_cfg_test extends E2EBaseTest {
    ...
    public void validateLeftPassword() {
        ...
        assertEquals("Decrypt Password Failure: ", "myspecialpassword",
                getConfigService().getConfig().getCluster(Environment.LEFT).getHiveServer2().getConnectionProperties().getProperty("password"));
    }
    ...
    public void validateLeftMSPassword() {
        ...
        assertEquals("Decrypt Password Failure: ", "cdpprivaatebase",
                getConfigService().getConfig().getCluster(Environment.LEFT).getMetastoreDirect().getConnectionProperties().getProperty("password"));
    }
    ...
    public void validateRightPassword() {
        // Get Runtime Return Code.
        assertEquals("Decrypt Password Failure: ", "myspecialpassword",
                getConfigService().getConfig().getCluster(Environment.RIGHT).getHiveServer2().getConnectionProperties().getProperty("password"));
    }
