...
public class EndToEndCDPTest extends EndToEndBase {
    ...
    @Test
    public void test_SM_to_Ozone_with_epl () {
    ...
    @Test
    public void test_SM_src_mismatch_cfg () {
        /*
    ...
    @Test
    public void test_SM_to_Ozone_w_epl_dc () {
        /*
         */
        String nameofCurrMethod = new Throwable()
                .getStackTrace()[0]
    ...
    @Test
    public void test_SM_to_Ozone_w_epl_dc_wo_glm () {
        /*
...
//                "-rdl",
    ...
    @Test
    public void test_SM_to_Ozone_w_epl_dc_w_glm () {
        /*
        Issues: Need to post warning when table/partition(s) new location isn't in the -[e]wd location.
