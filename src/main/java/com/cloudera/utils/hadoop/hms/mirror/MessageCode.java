...
//            "Use SCHEMA_ONLY from External and Legacy Managed (Non-Transactional) tables."),
    ...
    DISTCP_OUTPUT_NOT_REQUESTED(55, "To get the `distcp` workplans add `-dc|--distcp` to commandline."),
    DISTCP_RDL_WO_WAREHOUSE_DIR(56, "When using `-rdl|--reset-to-default-location` you must also specify " +
